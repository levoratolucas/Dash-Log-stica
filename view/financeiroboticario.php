  ...
  <div class="dados_full" style="max-height: 600px; margin-top:10px; overflow:auto;">
    <div class="dados95">
      ...
      foreach ($meses as $mes) {
        ...
        $sql_spree = "SELECT 
        'boticario' as loja ,
        CONCAT('R$ ', FORMAT(count(plp.objeto) * 10.8 + sum(f.valor * 1.3), 2)) as Valor_cobrar,
        CONCAT('R$ ', FORMAT(count(plp.objeto) * 10.8, 2)) as Adicionais,
        ...
        WHERE 
            f.mes = ".$mes." AND st.code LIKE '%boticario%';
        ";
